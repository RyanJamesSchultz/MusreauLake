function [Mmax]=Mmax(V,params,type_flag)
  ...
  if(strcmpi(type_flag,'McGarr'))
      ...
      Mmax=(log10(Mo)-9.1)/1.5; % Seismic moment in N m.
  ...
  % The next record breaking event relationship [Mendecki, 2016].
  elseif(strcmpi(type_flag,'NRBE'))
